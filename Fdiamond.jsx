...
function Fdiamond() {
  ...
  const hairstyles = [
      ...
      image: "/src/components/retrieved_images/DF1.jpg",
    },
    {
      name: "short layered bob",
      image: "/src/components/retrieved_images/DF2.jpg",
    },
    {
      name: "long layers",
      image: "/src/components/retrieved_images/DF3.jpg",
    },
    {
      name: "layers with soft layers",
      image: "/src/components/retrieved_images/DF4.jpg",
    },
    {
      name: "long layers with blunt ends",
      image: "/src/components/retrieved_images/DF5.jpg",
    },
    {
      name: "side bangs",
      image: "/src/components/retrieved_images/DF6.jpg",
    },
  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">Recommended Haircuts for Diamond Face</h1>
