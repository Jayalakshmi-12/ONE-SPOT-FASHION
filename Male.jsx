  ...
  const shapes = [
    {
      key: 'round',
      label: 'Round',
      image: '/src/components/retrieved_images/bround.jpg', // put this image in public/shapes/
    },
    {
      key: 'rectangle',
      label: 'Rectangle',
      image: '/src/components/retrieved_images/brectangle.jpg',
    },
    {
      key: 'heart',
      label: 'Heart',
      image: '/src/components/retrieved_images/bheart.jpg',
    },
    {
      key: 'diamond',
      label: 'Diamond',
      image: '/src/components/retrieved_images/bdiamond.jpg',
    },
    {
      key: 'oval',
      label: 'Oval',
      image: '/src/components/retrieved_images/boval.jpg',
    },
    {
      key: 'square',
      label: 'Square',
      image: '/src/components/retrieved_images/bsquare.jpg',
    },
  ];
    ...
    <div className="p-6 text-center relative bg-amber-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 justify-center max-w-6xl mx-auto">
        {shapes.map((shape) => (
          <div
            key={shape.key}
            onClick={() => navigate(`/male/${shape.key}`)}
