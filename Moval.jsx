...
function Moval() {
  ...
  const hairstyles = [
    {
      name: "Ivy League Cut",
      image: "/src/components/retrieved_images/OFM1.jpg",
    },
    {
      name: "Medium Brushed-Back Layers",
      image: "/src/components/retrieved_images/OFM2.jpg",
    },
    {
      name: "Two-Block Cut with Fringe (Korean Style)",
      image: "/src/components/retrieved_images/OFM3.jpg",
    },
    {
      name: "Classic Taper with Soft Part",
      image: "/src/components/retrieved_images/OFM4.jpg",
    },
    {
      name: "Curly Crop with Low Fade",
      image: "/src/components/retrieved_images/OFM5.jpg",
    },
    {
      name: "Textured Fringe with Fade",
      image: "/src/components/retrieved_images/OFM6.jpg",
    },
  ];
  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">Recommended Haircuts for Oval Face (Male)</h1>
