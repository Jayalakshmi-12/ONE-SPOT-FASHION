...
function Fround() {
  ...
  const [currentIndex, setCurrentIndex] = useState(0);
   ...
   const hairstyles = [
    {
      name: "layered haircut with curtain bangs",
      image: "/src/components/retrieved_images/RF1.jpg",
    },
    {
      name: "layered medium length with bangs",
      image: "/src/components/retrieved_images/RF2.jpg",
    },
    {
      name: "layered medium length",
      image: "/src/components/retrieved_images/RF3.jpg",
    },
    {
      name: "long bob with side_swept bangs",
      image: "/src/components/retrieved_images/RF4.jpg",
    },
    {
      name: "layered haircut",
      image: "/src/components/retrieved_images/RF5.jpg",
    },
    {
      name: "long layered haircut with curtain bangs",
      image: "/src/components/retrieved_images/RF6.jpg",
    },

  ];

  // Open modal with the selected hairstyle
  ...
  // Navigate to previous hairstyle
  const showPrev = (e) => {
    e.stopPropagation();
    setCurrentIndex((prevIndex) => (prevIndex > 0 ? prevIndex - 1 : hairstyles.length - 1));
  };

  // Navigate to next hairstyle
  const showNext = (e) => {
    e.stopPropagation();
    setCurrentIndex((prevIndex) => (prevIndex < hairstyles.length - 1 ? prevIndex + 1 : 0));
  };
  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">Recommended Haircuts for Round Face</h1>
        ...
        >
          ...
          >
            <div className="flex flex-col items-center">
              <h3 className="text-2xl font-bold text-amber-800 mb-4">{hairstyles[currentIndex].name}</h3>
              <img
