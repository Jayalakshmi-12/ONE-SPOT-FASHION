...
function Foval() {
  ...
  const hairstyles = [
      {
      name: "Long Layers",
      image: "/src/components/retrieved_images/OF1.jpg",
    },
    {
      name: "Side-Swept Bangs with short layers",
      image: "/src/components/retrieved_images/OF2.jpg",
    },
    {
      name: "long soft waves",
      image: "/src/components/retrieved_images/OF3.jpg",
    },
    {
      name: "curtain bangs with medium layers",
      image: "/src/components/retrieved_images/OF4.jpg",
    },
    {
      name: "Side-Swept Bangs with medium layers",
      image: "/src/components/retrieved_images/OF5.jpg",
    },
    {
      name: "side bangs with medium length",
      image: "/src/components/retrieved_images/OF6.jpg",
    },
  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">Recommended Haircuts for Oval Face</h1>
