...
function Fsquare() {
  ...
  const hairstyles = [
    {
      name: "short waves",
      image: "/src/components/retrieved_images/SF1.jpg",
    },
    {
      name: "short wavy bob",
      image: "/src/components/retrieved_images/SF2.jpg",
    },
    {
      name: "soft wave layers",
      image: "/src/components/retrieved_images/SF3.jpg",
    },
    {
      name: "short bob",
      image: "/src/components/retrieved_images/SF4.jpg",
    },
    {
      name: "voluminous layers",
      image: "/src/components/retrieved_images/SF5.jpg",
    },
    {
      name: "layers with bangs",
      image: "/src/components/retrieved_images/SF6.jpg",
    },
  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">Recommended Haircuts for Square Face</h1>
