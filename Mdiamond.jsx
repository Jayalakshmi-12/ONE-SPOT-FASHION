  ...
  const hairstyles = [
    {
      ...
      image: "/src/components/retrieved_images/DFM1.jpg",
    },
    {
      name: "Curly Fringe with Taper Fade",
      image: "/src/components/retrieved_images/DFM2.jpg",
    },
    {
      name: "Buzz Cut with Mid Fade and Beard",
      image: "/src/components/retrieved_images/DFM3.jpg",
    },
    {
      name: "Side Swept Undercut",
      image: "/src/components/retrieved_images/DFM4.jpg",
    },
    {
      name: "Messy Textured Curly Crop",
      image: "/src/components/retrieved_images/DFM5.jpg",
    },
    {
      name: "Classic Side Part with Volume",
      image: "/src/components/retrieved_images/DFM6.jpg",
    },
  ];
    ...
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">
          Recommended Haircuts for Diamond Face (Male)
        </h1>
