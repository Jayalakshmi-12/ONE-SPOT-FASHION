...
function Mheart() {
  ...
  const hairstyles = [
    {
      name: "Pompadour with Taper Fade",
      image: "/src/components/retrieved_images/HFM1.jpg",
    },
    {
      name: "Messy Fringe / Textured Mop",
      image: "/src/components/retrieved_images/HFM2.jpg",
    },
    {
      name: "Classic Comb Over with Fade",
      image: "/src/components/retrieved_images/HFM3.jpg",
    },
    {
      name: "Middle-Parted Flow (Modern Curtain)",
      image: "/src/components/retrieved_images/HFM4.jpg",
    },
    {
      name: "Wavy Curtain",
      image: "/src/components/retrieved_images/HFM5.jpg",
    },
    {
      name: "Messy Textured Medium Cut",
      image: "/src/components/retrieved_images/HFM6.jpg",
    },
  ];
    ...
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">
          Recommended Haircuts for Heart-Shaped Face (Male)
        </h1>
        <p className="text-amber-700 mb-8">
          Click on a haircut to see it in detail
        </p>
          ...
          {hairstyles.map((style, index) => (
            ...
            >
              <div className="bg-white p-6 rounded-xl shadow-lg border-2 border-amber-200 hover:border-amber-400 transition-colors">
                ...
                />
                <h2 className="text-xl font-semibold mt-4 text-amber-800">
                  {style.name}
                </h2>
              </div>
            </div>
