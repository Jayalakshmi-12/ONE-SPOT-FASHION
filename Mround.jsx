...
function Mround() {
  ...
  const hairstyles = [
    {
      name: "Short Textured Crop with Fade",
      image: "/src/components/retrieved_images/RFM1.jpg",
    },
    {
      name: "Classic Side Part / Ivy League",
      image: "/src/components/retrieved_images/RFM2.jpg",
    },
    {
      name: "Pompadour with Low Fade",
      image: "/src/components/retrieved_images/RFM3.jpg",
    },
    {
      name: "Side Swept Undercut",
      image: "/src/components/retrieved_images/RFM4.jpg",
    },
    {
      name: "Medium-Length Layered Curtains",
      image: "/src/components/retrieved_images/RFM5.jpg",
    },
    {
      name: "Modern Taper Fade with Textured Top",
      image: "/src/components/retrieved_images/RFM6.jpg",
    },
  ];
    ...
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">
          Recommended Haircuts for Round Face (Male)
        </h1>
