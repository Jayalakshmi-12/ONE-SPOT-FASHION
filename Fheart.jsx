...
function Fheart() {
  ...
  const hairstyles = [
    {
      name: "Layers with face framing layers",
      image: "/src/components/retrieved_images/HF1.jpg",
    },
    {
      name: "medium length layers",
      image: "/src/components/retrieved_images/HF2.jpg",
    },
    {
      name: "modern shag",
      image: "/src/components/retrieved_images/HF3.jpg",
    },
    {
      name: "layered haircut",
      image: "/src/components/retrieved_images/HF4.jpg",
    },
    {
      name: "Side-Swept layers with side bangs",
      image: "/src/components/retrieved_images/HF5.jpg",
    },
    {
      name: "long bob",
      image: "/src/components/retrieved_images/HF6.jpg",
    },
  ...
  return (
    <div className="bg-amber-50 min-h-screen">
      ...
      <div className="p-8 text-center">
        <h1 className="text-3xl font-bold mb-4 text-amber-900">Recommended Haircuts for Heart Face</h1>
